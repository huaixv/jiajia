...
void jia_exit() {
  ...
  if (hostc > 1) {
    ...
    if (jia_pid == 0) {
      ...
      printf("\nSIGIO time (Over)  = ");
      for (i = 0; i < hostc; i++)
        printf("%8.2f ", allstats[i].overlapsigiotime / 1000000.0);
      printf("\nEncode diff time   = ");
      for (i = 0; i < hostc; i++)
      ...
      printf("\ncomm soft time     = ");
      for (i = 0; i < hostc; i++)
        printf("%8.2f ", allstats[i].commsofttime / 1000000.0);
      printf("\ncomm hard time     = ");
      for (i = 0; i < hostc; i++)
        printf("%8.2f ", allstats[i].commhardtime / 1000000.0);
      /*printf("\nWait time          = ");
      for (i=0; i<hostc; i++) printf("%8.2f ",
      allstats[i].waittime/1000000.0);*/
      ...
      printf("\nServer time        = ");
      for (i = 0; i < hostc; i++)
        printf("%8.2f ", (allstats[i].usersigiotime + allstats[i].synsigiotime +
                          allstats[i].segvsigiotime +
